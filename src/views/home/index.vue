      ...
      <van-tabs v-model="active">
        <van-tab>
          ...
          <van-form @submit="onSubmit">
            ...
            <van-field v-model="form.Phone" clearable type="number" name="手机号" placeholder="手机号" :rules="[
        { required: true, message: '请填写手机号' },
        { pattern: /^1[3456789]\d{9}$/, message: '手机号格式不正确' },
      ]" />
            <van-field v-model="form.Code" clearable name="验证码" placeholder="验证码"
              :rules="[{ required: true, message: '请填写验证码' }]">

              <template #button>
                <van-button v-if="seconds < 1" :disabled="disabled" loading-type="spinner" size="small" type="primary"
            ...
            <div style="margin: 16px 0">
              ...
              <van-button type="primary" color="linear-gradient(to bottom, #347AFF, #1772ff)" native-type="submit"
                block>提
                交</van-button>
            </div>
          </van-form>
